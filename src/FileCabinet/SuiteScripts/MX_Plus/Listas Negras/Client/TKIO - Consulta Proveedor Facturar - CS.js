...
function (currentRecord, log, search, message) {
    ...
    function fieldChanged(scriptContext) {
        try {
            ...
            if (fieldId === 'entity') {
                ...
                // var vendorBillId = currentRecord.id;
                // var urlParams = {
                //     id: vendorBillId,
                //     entity: vendorId
                // };
                // var url = '/app/accounting/transactions/vendbill.nl?' + new URLSearchParams(urlParams).toString();
    ...
    function saveRecord(scriptContext) {
        ...
        if (statusPvd === 'Definitivo') {
            // objMsg.status = statusPvd
            // objMsg.message = 'El proveedor se encuentra en la lista negra 69b del SAT con un estatus de: <b>' + statusPvd + '</b>, esta trasacción <b>no</b> se podra guardar';
            // createMessage(objMsg);
            return false;
